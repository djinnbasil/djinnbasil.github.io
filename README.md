...
IT IS A GAME SELLING WEBSITE EXCLUSIVELY FOR PS4/XBOX Games. At the moment the index.html is the home page and about.html is the about. Clickable links can be used to navigate between the pages. WireFrames are also included in the zip. It is in Adobe XD. There is a folder called screenshots that has the screenshots for the website as well as the wireframes. Custom css is in the css folder called site.css 

I have used card views, carousels ,grids,columns ,Based on usage cols have been divided into 8,4 OR 9,3 OR 10,2.

Steps Implemented :

1.NavBar
2.Carousel
3.Card Over Carousel
4.Game Card Grid
5.Aside Bar -Advertisement Cards
7.Footer
8.About-Image wide
9.Card Description- Dummy
10.Custom CSS
11.README
12.Bootstrap 4  (hide on small devices for some elements.)
